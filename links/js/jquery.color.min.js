...
!(function (r, n) {
  ...
  function b(n) {
    ...
    return (
      ...
      o.length
        ? ("0,0,0,0" === o.join() && r.extend(o, t.transparent), e)
        : t[n]
    );
  }
  function g(r, n, t) {
  ...
  (c.style.cssText = "background-color:rgba(1,1,1,.5)"),
    ...
    (s.fn = r.extend(s.prototype, {
      parse: function (e, o, a, i) {
        if (e === n) return (this._rgba = [null, null, null, null]), this;
        (e.jquery || e.nodeType) && ((e = r(e).css(o)), (o = n));
        var l = this,
          f = d(e),
          c = (this._rgba = []);
        return (
          o !== n && ((e = [e, o, a, i]), (f = "array")),
          "string" === f
            ? this.parse(b(e) || t._default)
            : "array" === f
            ? (p(u.rgba.props, function (r, n) {
                c[n.idx] = h(e[n.idx], n);
              }),
              this)
            : "object" === f
                ...
                e instanceof s
                  ...
                  : function (n, t) {
                      ...
                      p(t.props, function (r, n) {
                        if (!l[o] && t.to) {
                          if ("alpha" === r || null == e[r]) return;
                          l[o] = t.to(l._rgba);
                        }
                        l[o][n.idx] = h(e[r], n, !0);
                      }),
                        l[o] &&
                          r.inArray(null, l[o].slice(0, 3)) < 0 &&
                          (null == l[o][3] && (l[o][3] = 1),
            ...
            return (
              i &&
                ...
                p(o.props, function (r, n) {
                  if (null != i[n.idx]) return (t = i[n.idx] === a[n.idx]);
                })),
              t
            );
          }),
    ...
    (u.hsla.from = function (r) {
      ...
      var n = r[0] / 360,
        ...
        i = 2 * e - a;
      return [
        Math.round(255 * g(i, a, n + 1 / 3)),
        Math.round(255 * g(i, a, n)),
        Math.round(255 * g(i, a, n - 1 / 3)),
        o,
      ];
    }),
    p(u, function (r, t) {
      var e = t.props,
        ...
        u = t.from;
      (s.fn[r] = function (r) {
        if ((i && !this[o] && (this[o] = i(this._rgba)), r === n))
          return this[o].slice();
        var t,
          a = d(r),
          l = "array" === a || "object" === a ? r : arguments,
          f = this[o].slice();
        return (
          p(e, function (r, n) {
            var t = l["object" === a ? r : n.idx];
            null == t && (t = f[n.idx]), (f[n.idx] = h(t, n));
          }),
          u ? (((t = s(u(f)))[o] = f), t) : s(f)
        );
      }),
        p(e, function (n, t) {
          s.fn[n] ||
            (s.fn[n] = function (e) {
              var o,
                i = d(e),
                s = "alpha" === n ? (this._hsla ? "hsla" : "rgba") : r,
                u = this[s](),
                l = u[t.idx];
              return "undefined" === i
                ? l
                : ("function" === i && (i = d((e = e.call(this, l)))),
                  null == e && t.empty
                    ? this
                    : ("string" === i &&
                        (o = a.exec(e)) &&
                        (e = l + parseFloat(o[2]) * ("+" === o[1] ? 1 : -1)),
                      (u[t.idx] = e),
                      this[s](u)));
            });
        });
        ...
        (r.cssHooks[t] = {
          set: function (n, e) {
            ...
            if ("transparent" !== e && ("string" !== d(e) || (o = b(e)))) {
              if (((e = s(o || e)), !f.rgba && 1 !== e._rgba[3])) {
                for (
                  a = "backgroundColor" === t ? n.parentNode : n;
                  ("" === i || "transparent" === i) && a && a.style;

                )
                  try {
                    (i = r.css(a, "backgroundColor")), (a = a.parentNode);
                  } catch (n) {}
